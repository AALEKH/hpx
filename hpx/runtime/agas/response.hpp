...
template <>
struct get_remote_result<std::uint32_t, agas::response>
{
        ...
        )
    {
        ...
        HPX_THROW_EXCEPTION(bad_parameter,
            "get_remote_result<std::uint32_t, agas::response>::call",
            "unexpected action code in result conversion");
        return 0;
    }
};
...
template <>
struct get_remote_result<std::int64_t, agas::response>
{
        ...
        )
    {
        ...
        HPX_THROW_EXCEPTION(bad_parameter,
            "get_remote_result<std::int64_t, agas::response>::call",
            "unexpected action code in result conversion");
        return 0;
    }
};
...
template <>
struct get_remote_result<std::vector<std::uint32_t>, agas::response>
{
        ...
        )
    {
        ...
        HPX_THROW_EXCEPTION(bad_parameter,
            "get_remote_result<std::vector<std::uint32_t>, agas::response>::call",
            "unexpected action code in result conversion");
